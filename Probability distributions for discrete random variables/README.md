...
На новый год Алексей решил научится жонглировать тремя мандаринами. Каждая попытка заканчивается успехом с вероятностью 0,2. Он тренируется до первого успешного запуска.
Случайная величина Z — номер попытки, в которой впервые всё получилось.Требуется найти:
